...
TEXT = {
    "zh": {
        ...
        "wake_lock_off": "常亮",
        "wake_lock_on": "常亮中",
        "wake_lock_failed": "当前浏览器或非安全连接不支持常亮，请调高锁屏时间，或在电脑端开启 HTTPS 再次扫码访问。",
        "use_https_label": "启用 HTTPS (局域网加密)",
        "security_tip": "💡 提示：首次扫码时，手机端可能会提示安全警告。这是局域网自签名证书的正常现象。请在手机浏览器点击「高级/显示详情」并选择「继续访问」即可，数据传输完全安全且只在本地局域网进行。",
        "send": "发送到电脑",
        "drop": "投递",
        "drop_and_send": "投递并发送",
        "sending": "投递中...",
    ...
    "en": {
        ...
        "clear": "Clear",
        "wake_lock_off": "Awake",
        "wake_lock_on": "Awake On",
        "wake_lock_failed": "This browser or HTTP connection cannot keep the screen awake. Increase phone auto-lock time, or enable HTTPS on the PC and scan again.",
        "use_https_label": "Enable HTTPS (LAN Encrypted)",
        "security_tip": "💡 Note: The phone may show a security warning on first access due to local self-signed HTTPS. It is 100% safe. Just tap 'Advanced' / 'Show Details' and select 'Proceed/Trust' to continue.",
